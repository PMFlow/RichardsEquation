...
'main_Richiards_2D_FlowTransp_benchmark.m' it the code which solves the 2D problem obtained 
	by coupling a nonlinear reactive-transport problem with the 2D benchmark flow-problem 			considered by [Schneid, 2000; List and Radu, 2016].

'BGRW_Alt_rand_benchmark.m' is the function solving the transport step of the coupled 
