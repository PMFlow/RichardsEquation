%% 2D GRW algorithm for advection-diffusion in random fields
close all; clear all;
...
meanVx=0; meanVy=0;
for k=1:R
    load(['GAUSS','/dataGAUSS_',num2str(k),'.mat']);
...
Pe=U_MEAN*dx/D1
t=1:T;
% save ('ensemble_coefficients','t','dt','Mx','My','Dx','Dy')
toc % Elapsed time is 1.393765 seconds  (Laptop 16 GB, 2.11 GHz)
